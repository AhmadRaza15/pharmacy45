          ...
          <div class="col-xs-6">
              <div class="">
                        <h3 style="margin-top:15px;margin-bottom:0; text-align: center; font-weight: bold; font-size:20px;">
                            <i  aria-hidden="true"></i> TRIAL CREDIT BALANCE REPORT</h3>
          ...
          <table class="table" style="zoom:100%; margin-top: 20px;" >
            ...
            <tbody style="">
                ...
                <tr >
                  ...
                  <td style="background: gray;"><?php echo $res->region_code; ?></td>
                  <td colspan="4" style="background: gray;"><?php echo $res->region_name; ?></td>
                 

                 </tr>
                 <?php $debit=0; ?>
                 <?php if (count($company)) { $i=2; foreach($company as $row):?>
                 <?php if($res->region_code == $row->region_company_code ) { ?>
                <tr>
                 <!--  <td><?php echo $i; ?></td> -->
                 <td><?php echo ($res->region_code. '-' . $row->come_code); ?></td>
