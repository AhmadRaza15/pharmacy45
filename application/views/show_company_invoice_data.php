...
<div class="wrapper">
  ...
  <div class="content-wrapper" >
    ...
    <section class="content-header">
           ...
           <form  method="POST" action="<?php echo base_url();?>Admin_c/company_order_pdf" class="form-horizontal">
<div class="box-body">
...
<div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label" style="margin-left:7%;">Select Company</label>
                  <div class="col-sm-4">
