                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h3 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i> View Item For Customer </h3>
                            </div>
                            <!-- <a href="<?php echo base_url(); ?>Admin_dashboard/newuser" class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span> Add User
                            </a> --> <br>

            <div class="box-body">
              <a href="<?php echo base_url(); ?>Admin_c/add_party_multiple_items" class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span> Generate Item For Customer
                            </a> <br><br>
              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php if (count($multiple) > 0) { $i=1; foreach($multiple as $row){ ?>
                <tr >
                  <td><?php echo $i; ?></td>
                  ...
                  <a href="<?php echo base_url(); ?>Admin_c/edit_multiple_items/<?php echo $row->id; ?>" ><button class="btn btn-primary" type="submit" >Edit</button></a> &nbsp; <a onClick="return doconfirm()" href="<?php  echo base_url(); ?>Admin_c/delete_multile_item/<?php echo $row->id; ?>" class="del"><button class="btn btn-danger" type="submit" >Delete</button></a>
                  </td> 
                </tr>
                 <?php  $i++; }
               }else{
