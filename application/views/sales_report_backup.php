          ...
          <div class="col-xs-6">
              <div class="">
                        <h3 style="margin-top:15px;margin-bottom:0; text-align: center; font-weight: bold; font-size:20px;">
                            <i  aria-hidden="true"></i>PENDING ORDERS REPORT</h3>
        ...
        <!--       <th>Code</th> -->
            ...
            <tbody>
                ...
                <tr >
                  ...
                  <td>
                    <?php echo $row->party_code;?><br><?php echo $row->party_name; ?><br><?php echo $row->address_1; ?><br>
