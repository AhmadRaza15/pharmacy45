      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="col-xs-3">
              <div class="">
                        ...
                        <h3 style="margin-top:0px;margin-bottom:0; text-align: center;  font-size:14px; font-weight: bold;">
                            <i  aria-hidden="true"></i><?php echo date('M-d-Y');?></h3>
              </div>
          </div>
          <div class="col-xs-5" style="border:1px solid;">
            ...
            <!-- <h3 style="margin-top:0px;margin-bottom:0; text-align: left; font-size:14px;">
                            <i  aria-hidden="true"></i> <b>Total AMOUNT:</b> <?php echo $billing->total_amount?></h3>
            <h3 style="margin-top:0;margin-bottom:0; text-align: left; font-size: 14px; ">
                                    <i  aria-hidden="true"></i><b>PAID AMOUNT:</b> <?php echo $billing->paid?></h3>
            <h3 style="margin-top:0;margin-bottom:0; text-align: left; font-size: 14px;">
...
<!--                   <td><?php echo $row->quantity;?></td> -->
       ...
       <div class="col-xs-12">
          <table class="table" style="zoom:100%; margin-top: 20px;" >
            ...
            <tbody style="">
                ...
                <tr>
                 <!--  <td><?php echo $billing->discount?>%</td> -->
                  <td class="text-center"><?php echo $billing->total_amount?></td>
                  
                  <!-- <td><?php echo $billing->paid?></td>
                  <td><?php echo $billing->remaining?></td> -->
    ...
    <!--  <div style="margin-right:140px;"></div> -->
     <a href="<?php echo base_url('Admin_c/add_order')?>" class="pull-right" ><button style="margin-right:70px; " class="btn btn-primary btn-sm">
     Generate New Order</button></a>
