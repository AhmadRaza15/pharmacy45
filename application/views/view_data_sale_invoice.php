                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h3 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i> View Orders List </h3>
                            </div>
                            <!-- <a href="<?php echo base_url(); ?>Admin_dashboard/newuser" class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span> Add User
                            </a> --> <br>
            <a href="<?php echo base_url(); ?>Admin_c/add_order" class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span> Generate New Order
                            </a>                             
            <div class="box-body">
               ...
               <!--    <th>Item Name</th> -->
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                                <a href="<?php echo base_url(); ?>Admin_c/sale_invoice/<?php echo $row->number; ?>/printed"><button class="btn btn-info" type="submit" ><i class="fa fa-pencil"> Create Purchase Invoice </i></button></a>
                                <a onClick="return doconfirm();" href="<?php echo base_url(); ?>Admin_c/delete_invoice/<?php echo $row->number; ?>"><button class="btn btn-danger" type="submit" ><i class="fa fa-pencil"> Delete </i></button></a>
                                 <!-- <a href="" ><button class="btn btn-primary" type="submit" ><i class="fa fa-pencil"> Edit</i></button></a>  --><!-- <a href="<?php echo base_url(); ?>Admin_c/delete_order_data/<?php echo $row->id;
                                 ?>" class="del"><button class="btn btn-danger" type="submit" ><i class="fa fa-trash"> Delete</i></button></a>
                                </td> -->
                </tr>
                 <?php  $i++; }
               }else{
