                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h4 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i> <b>Add Brand</b>  </h4>
                            </div>
            ...
            <form class="form-horizontal" style="margin-left:200px;" action='<?php echo base_url(); ?>Admin_c/brandData' method="post">
              <div class="box-body">
                <div class="form-group">
                   ...
                   <div class="col-sm-8">
                    <input type="text" name="brand_code" class="form-control" id="brand_code" value="<?php echo $last; ?>" readonly="">
                   <!--  <p><span id="code_error" class="text-danger">This Code is  registered already</span></p> -->
                   </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Brand Name</label>
                  <div class="col-sm-8">
                    <input type="text" name="brand_name" class="form-control" id="inputEmail3" placeholder="Enter Brand Name" required="">
                  </div>
                </div>
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary pull-right" id="save_data" style="margin-right:155px;">Submit</button>
              </div>
            </form>
                                  </div>
                    </div>
...
<script type="text/javascript">
  ...
  $('#code_error').hide();
  $('#brand_code').on('keyup , change',function(){
  var code=$('#brand_code').val();
  $.ajax({
         url:"<?php echo base_url(); ?>Admin_c/check_brand_code",
         method:"POST",
         data:{code:code},
         ...
         $('#code_error').hide();
         $('#save_data').css('visibility','visible');
         }
      },
  });
  });
