               ...
               <!--    <th>Item Name</th> -->
                ...
                <tr>
                 ...
                 <!--  <td style="text-align: center;">
                                <a href="<?php echo base_url(); ?>Admin_c/sale_invoice/<?php echo $row->number; ?>/delete"><button class="btn btn-info" type="submit" ><i class="fa fa-pencil"> Create Sale Invoice </i></button></a>
