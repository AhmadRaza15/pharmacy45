                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h4 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i><b> View Regions List</b> </h4>
                            </div>
                            <!-- <a href="<?php echo base_url(); ?>Admin_dashboard/newuser" class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span> Add User
                            </a> --> <br>

            <div class="box-body">
              <a href="<?php echo base_url(); ?>Admin_c/add_region" class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span> Generate New Region
                            </a> <br><br>
              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <a href="<?php echo base_url(); ?>Admin_c/editRegion/<?php echo $row->region_id; ?>" ><button class="btn btn-primary" type="submit" >Edit</button></a> &nbsp;<a onClick="return doconfirm()" href="<?php  echo base_url(); ?>Admin_c/deleteRegion/<?php echo $row->region_id; ?>" class="del"><button class="btn btn-danger" type="submit" >Delete</button></a>
                  </td> 
                </tr>
                 <?php  $i++; }
               }else{
