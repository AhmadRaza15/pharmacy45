          ...
          <table class="table" style="zoom:100%; margin-top: 20px;" >
            ...
            <tbody style="">
                ...
                <?php  $total= $null_balance; ?>
                  <?php // if (count($order)) { $i=2;// foreach($order as $row):?>
                  
               <!--  <tr> -->
                 <!--  <td><?php echo $i; ?></td> -->
                 <!-- <td><?php echo 'Ord.'. $row->invoice_id; ?></td>
               ...
               <!-- <td><?php echo $row->remaining+$total; ?></td> -->
                   <?php //  $bal= $row->remaining+$total; ?>
