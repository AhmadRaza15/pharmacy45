...
<div class="wrapper">
  ...
  <div class="content-wrapper" >
       <section class="content-header">
                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h3 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i>  Generate Item For Customer  </h3>
                            </div>
            ...
            <div class="col-sm-8">
            <form class="form-horizontal"  action='<?php echo base_url(); ?>Admin_c/add_multiple_party_items' method="post">
              <div class="box-body">
            
             
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Select Item</label>
                  <div class="col-sm-8">
                    <select class="form-control item_id select2" id="item_id" name="item_id" required="">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                  <input type="text" id="code" class="form-control" readonly/ style="">
                  </div>
                </div>
                ...
                <input type="text" id="brand" class="form-control" readonly/ >
                  ...
                  <div class="col-sm-8">
                    ...
                    <option  name="com_id" value="<?php echo $row->party_id;?>"><?php echo $row->party_name. '-' . $row->party_code; ?></option>
                ...
                <div class="col-sm-4">
                <input type="number" id="" name="sale" class="form-control" required="">
                </div>
                </div>
                ...
                <div class="col-sm-4">
                <input type="number" id="" name="purchase" class="form-control" required="" >
                </div>
                </div>
              <!--   <div class="form-group">
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary pull-right" id="save">Add Item</button>
              </div>
            </div>
            </form>
          </div>
