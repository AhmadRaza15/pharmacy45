            ...
            <tbody>
                  <?php $grand_total=0; if (count($res)) { $i=1; foreach($res as $row):?>
                    <?php 
                     ...
                     $info=$this->Main_model->fetch_same_invoices($row->number);
                     ?>
                     <?php $grand_total=0; $i=1; foreach($info as $invoice): ?>
                <tr >
                 ...
                 <?php echo $invoice->address_1; ?><br>
                  <?php echo $invoice->item_name; ?></td> 
                 <?php } 
                 else 
                 {
                   ?><td><?php echo $invoice->item_name; ?></td><?php 
                 }
                  ?>
                 <td><?php echo $invoice->unit_price; ?></td>   
                 <td><?php echo $invoice->quantity; ?></td>   
                 <td><?php echo $total=$invoice->total; ?></td>
