                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h3 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i> View Party Items List </h3>
                            </div>
                            <!-- <a href="<?php echo base_url(); ?>Admin_dashboard/newuser" class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span> Add User
                            </a> --> <br>

            <div class="box-body">
              <a href="<?php echo base_url(); ?>Admin_c/add_party_items" class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span> Generate New Item
                            </a> <br><br>
              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td style="width:20%;"><?php echo $row->party_name; ?></td>
               <!--    <td><?php echo $row->date; ?></td> -->
                  <td><?php echo $row->cost_rate; ?></td>
                   <!-- <td><?php echo $row->stock_in_hand; ?></td>
                   <td><?php echo $row->stock_in_hand * $row->cost_rate; ?></td> -->
                  <td style="text-align: center;">
                                <a href="" ><button class="btn btn-primary" type="submit" >Edit</button></a> &nbsp; &nbsp; &nbsp;<a href="" class="del"><button class="btn btn-danger" type="submit" >Delete</button></a>
                                </td>
                </tr>
                 <?php  $i++; }
               }else{
