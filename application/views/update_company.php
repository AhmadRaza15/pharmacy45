                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h3 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i> Update Company </h3>
                            </div>
            ...
            <form class="form-horizontal" style="margin-left:200px;" action='<?php echo base_url(); ?>Admin_c/insert_company' method="post">
              ...
              <input type="hidden" name="id" value="<?php echo $res->company_id; ?>">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="company_code" class="form-control" id="code" readonly="" value="<?php echo $res->company_code; ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="company_name" class="form-control" id="inputEmail3" autocomplete="off" placeholder="Enter Company Name" required="" value="<?php echo $res->company_name; ?>">
                  </div>
                </div>
             ...
             <!--  <div id="alertDiv2" class="alert alert-info alert-dismissible" style="margin-top: 20px;width: 250px;display: none; margin-left:635px;">
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary pull-right" id="save" style="margin-right:155px;">Update Company</button>
              </div>
              <!-- /.box-footer -->
            </form>
                                  </div>
