                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h3 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i>  Party Price Allocation  </h3>
                            </div>
                            <br>
            <form class="form-horizontal" style="margin-left:120px;" action='<?php echo base_url(); ?>Admin_c/update_price_allocate' method="post">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select class="form-control party" name="party_name" style="width:506px;" required="">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select class="form-control item" name="item_name" style="width:506px;" required="">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" name="sale_rate" class="form-control" id="inputEmail3" value="<?php echo $ap->sale_rate;?>" required="" >
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input type="text" name="purchase_rate" class="form-control" id="inputEmail3" value="<?php echo $ap->purchase_rate;?>" required="">
                  </div>
                </div>
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary pull-right" style="margin-right:05px;">Update</button>
              </div>
              <!-- /.box-footer -->
            </form>
             </div>
...
<script type="text/javascript">
    ...
    //alert(company);
    $.ajax({
        url:"<?php echo base_url(); ?>Admin_c/fetch_company_item",
        method:"POST",
