                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h4 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i> <b>Add Region<b>  </h4>
                            </div>
                            <!-- <a href="<?php echo base_url(); ?>Admin_dashboard/newuser" class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span> Add User
                            </a> --> <br>
            <form class="form-horizontal"  action='<?php echo base_url(); ?>Admin_c/insertRegion' method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="code" class="form-control" id="code"  autocomplete="off" placeholder="Enter Region Code"  >
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="name" class="form-control " id="inputEmail3" autocomplete="off" placeholder="Enter Regoin Name" required="">
                  </div>
               <!--    <span class="text-danger">Region </span> -->
                </div>
