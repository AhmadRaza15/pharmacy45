     ...
     <div class="box box-info" >
            ...
            <!-- form start -->
             <?php if($this->session->flashdata('error')!=""){?>
                            ...
                            <?php };?>
            <form class="form-horizontal" style="margin:0px; padding:0px;"   action='<?php echo base_url(); ?>Admin_c/save_data_stock' method="Post"> 
                ...
                <div class="form-group" >
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    <option name="item_id" value="<?php echo $row->com_id?>"><?php echo $row->com_name?></option>
                   <?php } ?>
                  </select>
