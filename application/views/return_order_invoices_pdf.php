             ...
             <div class="col-xs-4">
              <div class="">
                        <h3 style="margin-top:15px;margin-bottom:0; text-align: center; font-weight: bold; font-size:20px;">
                            <i  aria-hidden="true"></i>RETURN ORDERS REPORT</h3>
            ...
            <tbody>
                  ...
                  <?php if (count($res)) {  $i=1; foreach($res as $row):?>
                    <?php $CI->load->model('Main_model');
                        $invoices =$this->Main_model->fecth_ivoices_by_number($row->invoice_id);
                    ?>
                    ...
                    <tr>
                      ...
                      <td><?php if($i==1){?><br><br><br><?php } ?><?php echo (-1) * $invoice->quantity; ?></td>
                      <td><?php if($i==1){?><br><br><br><?php } ?><?php echo (-1) * $invoice->total; ?></td>
                    </tr>
                ...
                <tr style="border-top:2px solid black;border-bottom:2px solid black;">
                  ...
                  <td><?php echo (-1) * $grand_total; $grand_total=0; ?></td>
                </tr >
