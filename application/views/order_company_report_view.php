                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h3 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i> Order Company Report </h3>
                            </div>
                            <!-- <a href="<?php echo base_url(); ?>Admin_dashboard/newuser" class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span> Add User
                            </a> --> <br>
           <form  method="POST" action="<?php echo base_url();?>Admin_c/show_company_order_report_view" class="form-horizontal">
<div class="box-body">
...
<div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label" style="margin-left:7%;">Party</label>
                  <div class="col-sm-4">
                    <select class="form-control com_id" name="company_id" required="">
                  ...
                  <div class="col-sm-2" style="margin-left:106px;">
                    <input  type="text" name="party_value" class="form-control code" placeholder="Party Code" readonly="" >
                  </div>
...
<div class="col-sm-7">
    <div class="form-group">
                <div class="input-group date">
                  ...
                  <input type="text" name="start_date" class="form-control pull-right" id="datepicker1">
                </div>
                <!-- /.input group -->
              </div></div>
</div> 
        ...
        $.ajax({
                        ...
                        success  :  function (data) {
                          // alert(company_name);
                            ...
                            $('.company_name').val(data.party_id);
