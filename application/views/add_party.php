    ...
    <!-- Content Header (Page header) -->
     ...
     <section class="content-header">
                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h4 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i><b> Add New Party</b> </h4>
                            </div>
            ...
            <!-- <?php if($this->session->flashdata('msg')){ ?>
               ...
               <?php } ?>      -->           
            <form class="form-horizontal" style="margin-left:200px;" action='<?php echo base_url(); ?>Admin_c/insert_party_data' method="post">
              <div class="box-body">
                 <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Select Region</label>
                  <div class="col-sm-8">
                    <select class="form-control region_id" name="region_id" >
                           <option selected="" value="">Select Region</option>
                           <?php foreach($res as $row) { ?>
                           <option name=region_id" value="<?php echo $row->region_id; ?>"  class="form-control"><?php echo $row->region_name; ?></option>
                           <?php } ?>
                    </select>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="region_code" class="form-control region_code" id="inputEmail3" readonly="" placeholder="Region Code" >
                  </div>
                </div>
                <div class="form-group">
                  <label for="party_code" class="col-sm-2 control-label">Party Code</label>
                  <div class="col-sm-4">
                    <input type="text" name="code"  class="form-control" id="party_code" autocomplete="off" placeholder="Party Code" >
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Party Name</label>
                  <div class="col-sm-8">
                    <input type="text" name="name" class="form-control" id="inputEmail3" autocomplete="off" placeholder="Party Name">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Address 1 &nbsp;</label>
                  <div class="col-sm-8">
                    <input type="text" name="one" class="form-control" id="inputEmail3" autocomplete="off" placeholder="Party Address 1">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Address 2  &nbsp;</label>
                  <div class="col-sm-8">
                    <input type="text" name="two" class="form-control" id="inputEmail3" autocomplete="off" placeholder="Party Address 2">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Party Contact</label>
                  <div class="col-sm-8">
                    <input type="text" name="phone" class="form-control" id="inputEmail3" autocomplete="off" placeholder="Party Contact">
                  </div>
                </div>
                 <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Party Debit</label>
                  <div class="col-sm-8">
                    <input type="text" name="debit" class="form-control" id="inputEmail3" autocomplete="off" placeholder="Party Debit">
                  </div>
                </div>
                 <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Party Credit</label>
                  <div class="col-sm-8">
                    <input type="text" name="credit" class="form-control" id="inputEmail3" autocomplete="off" placeholder="Party Credit">
                  </div>
                </div>
             <!--  <div class="form-group">
