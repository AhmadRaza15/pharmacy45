                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h3 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i> Items Report List </h3>
                            </div>
                            <!-- <a href="<?php echo base_url(); ?>Admin_dashboard/newuser" class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span> Add User
                            </a> --> <br>
           <form  method="POST" action="<?php echo base_url();?>Admin_c/showreport" class="form-horizontal">
<div class="box-body">
...
<div class="col-sm-7">
    <div class="form-group">
                <div class="input-group date">
                  ...
                  <input type="text" name="start_date" class="form-control pull-right" id="datepicker1" autocomplete="off" required="">
                </div>
                <!-- /.input group -->
              </div></div>
</div> 
...
<div class="col-sm-7">
    <div class="form-group">
                <div class="input-group date">
                  ...
                  <input type="text" name="end_date" class="form-control pull-right" id="datepicker2" autocomplete="off" required="">
                </div>
                <!-- /.input group -->
              </div>
</div>
...
<!-- /.box-footer -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="<?php echo base_url(); ?>assets/https://adminlte.io">Aun Solutions</a>.</strong> All rights
    reserved.
  </footer>
