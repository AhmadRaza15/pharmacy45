    ...
    <!-- Content Header (Page header) -->
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php if (count($multiple)) { $i=1; foreach($multiple as $row){ ?>
                <tr >
                  <td><?php echo $i; ?></td>
                  ...
                  <a href="<?php echo base_url(); ?>Admin_c/editBrand/<?php echo $row->brand_id; ?>" ><button class="btn btn-primary" type="submit" >Edit</button></a> &nbsp;<a onClick="return doconfirm()" href="<?php  echo base_url(); ?>Admin_c/deleteBrand/<?php echo $row->brand_id; ?>" class="del"><button class="btn btn-danger" type="submit" >Delete</button></a>
                  </td>  -->
                </tr>
                 <?php  $i++; }
               }else{
