    ...
    <!-- Content Header (Page header) -->
     ...
     <section class="content-header">
                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h3 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i> Update Brand  </h3>
                            </div>
            ...
            <?php if($this->session->flashdata('msg')){ ?>
               ...
               <?php } ?>                
            <form class="form-horizontal" style="margin-left:200px;" action='<?php echo base_url(); ?>Admin_c/updateBrand' method="post">
              ...
              <div class="box-body">
                 <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="brand_code" class="form-control" id="inputEmail3" value="<?php echo $res->brand_code; ?>" readonly="">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Brand Name</label>
                  <div class="col-sm-8">
                    <input type="text" name="brand_name" class="form-control" id="inputEmail3" value="<?php echo $res->brand_name; ?>" required="">
                  </div>
                </div>
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary pull-right" style="margin-right:155px;">Update Brand</button>
              </div>
            </form>
                                  </div>
                    </div>
