                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h3 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i> Order party Items Report </h3>
                            </div>
                            <!-- <a href="<?php echo base_url(); ?>Admin_dashboard/newuser" class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span> Add User
                            </a> --> <br>
           <form  method="POST" action="<?php echo base_url();?>Admin_c/show_item_order_report_view" class="form-horizontal">
<div class="box-body">
...
<div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    <option name="party_id" value="<?php echo $row->party_id?>"><?php echo $row->party_name?></option>
                   <?php } ?>
                  </select>
                  </div>

                  
                  <!--  <input type="hidden" name="come_code" class="code"> -->
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label" style="margin-left:7%;">Select Item</label>
                  <div class="col-sm-4">
                    <select class="form-control item_name" name="item_name" required="">
               
                    <option value="" required="" selected="">Select item Name</option>
                    <?php // foreach($items as $row) { ?>
                    <option name="item_name" value="<?php echo $row->item_name;?>"><?php echo $row->item_name;?></option>
                   <?php // } ?>
                  </select>
                  </div>
                  <!-- daikha?? hn -->
