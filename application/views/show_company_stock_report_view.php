                    ...
                    <div class="col-md-12">
                        <div class="box-body " style="background-color: white;">
                            <div class="well"><h3 style="margin-top:0;margin-bottom:0; text-align: center;">
                                    <i  aria-hidden="true"></i> Party Stock Report List </h3>
                            </div>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <?php $i=1; foreach ($stock as $item){?>
                                    ...
                                    <a  href="<?php echo base_url(); ?>Admin_c/company_stock_pdf/<?php echo $start_date; ?>/<?php echo $end_date; ?>/<?php echo $com_id; ?>" target="_blank" class="btn btn-primary pull-right"><i class="fa fa-file-pdf-o"></i> PDF </a>
                                    </td>
                                    </tr>
                                </tbody>
