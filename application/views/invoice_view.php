...
<body  class="hold-transition skin-blue sidebar-mini"  style="margin:0px; padding: 0px;" onload="window.print();">
          ...
          <div class="col-xs-6">
              <div class="">
                        <h3 style="margin-top:15px;margin-bottom:0; text-align: center; font-weight: bold; font-size:20px;">
                            <i  aria-hidden="true"></i>ORDER LEDGER REPORT</h3>
   ...
   <!--    <div class="row invoice-info">
      ...
      <div class="row" style="margin-top:1%">
        <div class="col-xs-12 table-responsive">
          <table class="table table-responsive" style="zoom:130%;" >
